...
public class EightPieceLeft extends SequentialCommandGroup {
  public EightPieceLeft(CommandSwerveDrivetrain swerveDrive, IntakeShooter intakeShooter, Climber climber) {
    try {
      var stopRequest = new SwerveRequest.ApplyRobotSpeeds();

      var m_path1 = swerveDrive.getTrajectoryUtils().generatePPHolonomicCommand("EightPieceLeftPath1");
      var m_path2 = swerveDrive.getTrajectoryUtils().generatePPHolonomicCommand("EightPieceLeftPath2");
